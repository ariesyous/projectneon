...
The local implementation is the Milestone 6 codebase migrated through WP01–WP03 scope. Never describe a later approved target as already implemented. Preserve historical M0–M6 verification, landed package contracts, and the isolated Milestone 5 compatibility boundary while migrating prospectively through the correct owner. There is no Milestone 7; WP04–WP07 remain separate, unstarted packages.
...
WP03 District Planning and Cards is the implemented runtime boundary and published owner-authorized `main`/GitHub Pages browser-playtest candidate as of 2026-08-22. Pending WP02/WP03 qualitative gates and WP03 publication do not authorize WP04–WP07, which require separate authorization package by package.
...
- `RewardDirector`: standard/equipment reward selection and application coordination, authored reward-tier advancement, coin ledger, at-most-once clusters, and manual streak; production WP03 no longer requests supplemental card rewards
...
There is no Milestone 7 or later milestone. WP00 replaces the former no-future-work statement with the approved WP01–WP07 sequence in `docs/product/ROADMAP.md`. WP01–WP03 are implemented within their recorded boundaries; WP04 is not started or implicitly authorized. Historical M6/WP01/WP02 evidence remains valid and must not be relabelled as final rebaseline acceptance.
