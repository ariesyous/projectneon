...
- Next-session TODO: representative 8–12 minute Victory and Extraction plus owner-facing Defeat validation; all actor/boss/intervention/settings/save/restart interactions; exact cadence-gap tuning; 1280 x 720 plus 1080p/1440p inspection; fresh Windows/Web exports and exported runtime/Web console; and Milestone 6 visual evidence. The cumulative harness exited 0 but emitted 48 ObjectDB and four resource-in-use shutdown diagnostics, so harness cleanup remains a diagnostic TODO; the configured production boot did not reproduce them.
